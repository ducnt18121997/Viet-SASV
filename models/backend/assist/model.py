...
from models.backend.assist.graph_layers import (
    GraphAttentionLayer,
    HtrgGraphAttentionLayer,
    GraphPool,
)
from models.backend.assist.layers import CONV, Residual_block
from models.backend.assist.config import AssistConfig
...
class Assist(nn.Module):
    def __init__(self, config: Optional[AssistConfig] = None):
        ...
        self.config = config if config else AssistConfig()
        filts = self.config.filts
